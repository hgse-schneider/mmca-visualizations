...
def generate_table(year1,year2,data,metric,outcome,instrument):
    ...
    table_header = [
            html.Thead(html.Tr([html.Th("Title"), html.Th("Year"),html.Th("Data"),html.Th("Metric"),html.Th("Outcome"),html.Th("Instrument")]))
        ]
    ...
    for paper in papers:
        rows_list.append(html.Tr([html.Td(paper.pub_year),
                              ...
                              html.Td(', '.join(list(set(list(paper.outcomes_sm.values()))))),
